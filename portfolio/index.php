                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                <div class="text-uppercase">Web Development &middot; FRONTEND &middot; freelancer</div>
                            </div>
                            <div class="fs-3 fw-light text-muted">
                                I develop modern and responsive</div>
                            <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Websites that grow
                                    businesses</span></h1>
                            <div
                    ...
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img class="profile-img" src="assets/profile-removebg-preview.png" alt="..." />
                                <div class="dots-1">
                                    <!-- SVG Dots-->
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <p class="fw-light text-justify p-2">Hi, I’m Kaung Htet San, a graduate of Yangon University
                                of Economics
                                with a Bachelor of Actuarial Science degree. I am passionate about web development and
                                enjoy creating modern, user-friendly, and responsive websites and applications.

                                Although my academic background is in actuarial science, my strong interest in
                                technology and programming led me to explore web development and continuously improve my
                                technical skills. I enjoy learning new tools, frameworks, and technologies that help
                                build efficient and engaging digital experiences.

                                I am a motivated and detail-oriented person with strong analytical and problem-solving
                                abilities developed through my studies in mathematics, statistics, and data analysis. I
                                enjoy turning ideas into real projects and continuously challenging myself to grow as a
                                developer.

                                My goal is to build a successful career in the tech industry where I can contribute to
                                innovative projects, improve my skills, and create impactful web applications that
                                provide real value to users.</p>
                            <div class="d-flex justify-content-center fs-2 gap-4">
                                <a class="text-gradient" href="#!"><i class="bi bi-facebook"></i></a>
                                <a class="text-gradient" href="#!"><i class="bi bi-telegram"></i></a>
